            ...
            <table id="myTable" class="display responsive " width="100%">
                ...
                <tbody>
                    ...
                    <tr class="trows">
                        ...
                        <td><?= $kelas?></td>
                        <td><?= $harga?></td>
                        <td><?= ($status == "confirmed")? "<a href='receipt.php?id=$id_transaksi' class='btn btn-outline-secondary' >Print Receipt</a>": "-"?></td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-4" id="exampleModalLabel">CONFIRM: <?= $namaBarang?></h1>
                                ...
                                <form action="fungsi/delData.php" method="post">
                                    ...
                                    <div class="modal-body">
                                        <h1 class="fs-5">Anda Yakin Ingin confirm pesanan?</h1>
